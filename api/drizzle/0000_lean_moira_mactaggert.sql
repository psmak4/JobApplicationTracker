CREATE TYPE "public"."application_status" AS ENUM('Applied', 'Phone Screen', 'Technical Interview', 'On-site Interview', 'Offer', 'Rejected', 'Withdrawn', 'Other');--> statement-breakpoint
CREATE TYPE "public"."work_type" AS ENUM('Remote', 'Hybrid', 'On-site');--> statement-breakpoint
